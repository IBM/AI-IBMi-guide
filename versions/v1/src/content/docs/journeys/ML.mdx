...
- **On an adjacent server** — Deploy the model on a Linux/Power server via the [Python Ecosystem for IBM Power](../../solutions/ibm/pyeco) near IBM i
- **In a managed ML platform** — Use model serving capabilities in [Red Hat OpenShift AI](../../solutions/redhat/rhoai), [Red Hat AI Inference Server](../../solutions/redhat/rhaiis), [Wallaroo AI Platform](../../solutions/wallaroo/ai_platform), or [watsonx.ai](../../solutions/ibm/watsonx_ai)
...
The [UNIXCMD project](https://www.scottklement.com/unixcmd/) provides a robust way to execute PASE commands from RPG.
...
For tighter integration, a Python-based scoring function will be able to be wrapped as an external UDF in Db2 for i using [Db2 for i AI SDK](../../../integrations/access_from_i/db2_sdk), allowing it to be called directly in SQL queries — scoring every row in a result set in a single statement. This capability is not yet implemented and will be supported in a future release.
