...
Training happens in a Python environment — either on IBM i itself (via the [Python Ecosystem for IBM Power](../../solutions/ibm/pyeco)), on an adjacent Linux/Power server, or in a cloud ML platform like [watsonx.ai](../../solutions/ibm/watsonx_ai) or [Red Hat OpenShift AI](../../solutions/redhat/rhoai).
