...
LLMs trained on or fine-tuned with IBM i code can assist developers in writing RPG, CL, and SQL. Tools like [IBM Bob](../../solutions/ibm/project_bob) and Continue (via the [Developer Experience](../../journeys/devx) journey) integrate LLM code assistance directly into the IDE.
