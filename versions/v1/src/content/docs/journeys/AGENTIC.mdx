...
[IBM Bob](https://bob.ibm.com/) is IBM's AI-powered development partner, built as an agentic coding assistant for the full software lifecycle. Bob operates in configurable agentic modes: you describe what you want, and Bob plans and executes across your codebase. Key capabilities include:
...
### Leading Trucking Partner

import { LinkCard as LC } from '@astrojs/starlight/components';

<Aside type="note">
  Full story on the [IBM i Stories](/stories/) page.
</Aside>

{/* TODO: Insert the leading trucking partner story from the IBM i stories page.
    Include: company context, the specific IBM i / AI integration used,
    and the concrete business outcomes (time saved, errors reduced, throughput gained, etc.) */}
