...
<Image width="1074" height="20" alt="image" src="https://github.com/user-attachments/assets/53edf48b-3428-41db-9502-4eb99f44e7d5" />
...
<Image width="934" height="20" alt="image" src="https://github.com/user-attachments/assets/3810c117-e0a1-466f-8897-b79618349239" />
...
<Image width="930" height="20" alt="image" src="https://github.com/user-attachments/assets/20a49746-05b3-419b-ab65-952d6466d929" />

### New data source in Infrastructure manager

<Image width="1065" height="20" alt="image" src="https://github.com/user-attachments/assets/6418077d-e4ec-40fe-bbb7-2bdb9697df84" />

### Exploring data  

Browse the schemas and tables using the newly added catalog in the presto engine from Data Manager page.

<Image width="1115" height="20" alt="image" src="https://github.com/user-attachments/assets/d621e805-171b-487a-b6f2-8bc97a4b689b" />

### Querying data  

Run SQL queries against the data in the new catalog in Query workspace page.

<Image width="1733" height="20" alt="image" src="https://github.com/user-attachments/assets/6946b1bf-6c23-476e-a6a6-141443e7eca2" />
