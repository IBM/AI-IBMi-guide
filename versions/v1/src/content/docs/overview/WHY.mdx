...
If you're new to AI on IBM i, the [Choosing an AI Stack](../CHOOSING_STACK) page walks through the landscape of tools and platforms available, from IBM-native solutions to open-source frameworks. The **Use Cases** section covers specific journeys: Machine Learning, Deep Learning, Generative AI, Agentic AI, and Developer Experience tooling.
