...
For workloads requiring even greater AI throughput, the **IBM Spyre Accelerator** is a PCIe-attached card designed specifically for large language model (LLM) inference on Power. See the [MMA](../mma) and [Spyre](../spyre) pages for details.
