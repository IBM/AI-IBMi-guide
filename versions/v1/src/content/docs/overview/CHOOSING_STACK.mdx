...
It has builtin exploitation of the [AI acceleration of the Power chipset](ai_hardware/mma).
...
advantage of the [AI acceleration of the Power chipset](ai_hardware/mma).
...
Some technologies are available to run natively on IBM i. See "[Running AI Natively on IBM i](../solutions/ibm/ibmi_native)"
